"""
Briefcase Kivy Bootstrap - Adds Kivy as a GUI framework option to Briefcase.

This package provides a bootstrap that allows users to select Kivy as a GUI framework
when creating new Briefcase projects using 'briefcase new'.
"""
